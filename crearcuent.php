			...
			<h1>Crear cuenta</h1>
				<div class="sbcreacnt">
					<div class="cntaregis">
						...
						<?php
						if (isset($_POST['btnenviar_email'])) {
							$f = $_POST['email_envio'];
						}
						?>
						<form action="insertar.php" method="post">
							...
							<div class="formail">
								...
								<input name="nombre" type="text" name="nombre">
							</div>

							<div class="formail">
								<label>Apellido*</label><br>
								<input name="apellido" type="text" name="apellido">
							</div>

							<div class="formail">
								<label>Correo electrónico*</label><br>
								<input name="email" type="email" name="correo" 
								value="<?php echo $f ?>">
							</div>

							<div class="formail">
								<label>Contraseña*</label><br>
								<input name="contraseña" type="password" name="pass"><br>
